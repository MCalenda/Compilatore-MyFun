...
void prova(char **a, int *b, int c, char *d)
{
    *a = concatString(*a, " e' cambiato");
    *b = 6;
    c = 7;
    d = concatString(d, " o forse si");
}
...
int main()
{
    ...
    int b = 5;
    int c = 6;
    char *d = "codesta non e' cambiata";
    prova(&a, &b, c, d);
    printf("%s", concatString(concatString(concatInt(concatString(concatInt(concatString(concatString(a, " "), " "), b), " "), c), " "), d));
    printf("\r\n");
    return 0;
}