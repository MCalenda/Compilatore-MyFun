...
scanf("%f", &op2);
printf("%s", "");
printf("\r\n"); printf("%s", concatReal( concatString( concatReal( concatString( concatReal( "La somma tra ", op1), " e "), op2), " vale "), op1 + op2));
printf("\r\n"); 
}
void do_mul() {
float op1;
...
scanf("%f", &op2);
printf("%s", "");
printf("\r\n"); printf("%s", concatReal( concatString( concatReal( concatString( concatReal( "La moltiplicazione tra ", op1), " e "), op2), " vale "), op1 * op2));
printf("\r\n"); 
}
void do_div_int() {
int op1;
...
scanf("%d", &op2);
printf("%s", "");
printf("\r\n"); printf("%s", concatInt( concatString( concatInt( concatString( concatInt( "La divisione intera tra ", op1), " e "), op2), " vale "), op1 / op2));
printf("\r\n"); 
}
void do_pow() {
float op1;
...
scanf("%f", &op2);
printf("%s", "");
printf("\r\n"); printf("%s", concatReal( concatString( concatReal( concatString( concatReal( "La potenza di ", op1), " elevato a "), op2), " vale "), pow(op1, op2)));
printf("\r\n"); 
}
...
scanf("%d", &n);
printf("%s", "");
printf("\r\n"); message = concatString( concatInt( "Il numero di Fibonacci in posizione ", n), " vale ");
if(recursive) {
